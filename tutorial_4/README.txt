...
Ansonsten funktioniert die Ausführung wie vorgegeben mit 2 Parameter (Input / Output-Files).

Die getaggten Token der Trainingsdaten sind im File output.iob ersichtlich.
